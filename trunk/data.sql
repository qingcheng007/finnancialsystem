...
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values('14', '发票管理', null, '3', '/admin/invoice/manage.jsp', '1', '管理发票模块', '1', 0, 1);
