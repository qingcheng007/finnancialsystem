...
$(function() {
	...
	function toJson() {
		...
		for ( var i = 1; i <= 3; i++) {
			...
			case '1': {
				if (i == 1)
					invoiceDetails.content1 = document.getElementById(inputName
							+ i).value;
				if (i == 2)
					invoiceDetails.content2 = document.getElementById(inputName
							+ i).value;
				if (i == 3)
					invoiceDetails.content3 = document.getElementById(inputName
							+ i).value;
	...
	function switchHide(n) {
		...
		document.getElementById('tr11-1').style.display = 'none';
		document.getElementById('tr12-2').style.display = 'none';
		document.getElementById('tr13-3').style.display = 'none';
		...
		document.getElementById('tr21-1').style.display = 'none';
		document.getElementById('tr22-2').style.display = 'none';
		document.getElementById('tr23-3').style.display = 'none';
		...
		document.getElementById('tr31-1').style.display = 'none';
		document.getElementById('tr32-2').style.display = 'none';
		document.getElementById('tr33-3').style.display = 'none';

		document.getElementById('tr41').style.display = 'none';
		document.getElementById('tr42').style.display = 'none';

		document.getElementById('tr41-1').style.display = 'none';
		document.getElementById('tr42-2').style.display = 'none';

		document.getElementById('tr51').style.display = 'none';
		document.getElementById('tr52').style.display = 'none';

		document.getElementById('tr51-1').style.display = 'none';
		document.getElementById('tr52-2').style.display = 'none';

		document.getElementById('tr71').style.display = 'none';
		document.getElementById('tr72').style.display = 'none';

		document.getElementById('tr71-1').style.display = 'none';
		document.getElementById('tr72-2').style.display = 'none';

		document.getElementById('tr81').style.display = 'none';
		document.getElementById('tr82').style.display = 'none';

		document.getElementById('tr81-1').style.display = 'none';
		document.getElementById('tr82-2').style.display = 'none';
		...
		document.getElementById('tr91-1').style.display = 'none';
		document.getElementById('tr92-2').style.display = 'none';
		document.getElementById('tr93-3').style.display = 'none';
		...
		document.getElementById('tr101-1').style.display = 'none';
		document.getElementById('tr102-2').style.display = 'none';
		document.getElementById('tr103-3').style.display = 'none';

		document.getElementById('tr111').style.display = 'none';
		document.getElementById('tr111-1').style.display = 'none';

		i = 1;
		for (; i <= 3; i++) {
			if (document.getElementById("tr" + n + i) != null) {
				document.getElementById("tr" + n + i).style.display = '';
				document.getElementById("tr" + n + i +'-'+ i).style.display = '';
		...
		<table class="addRank">
			<tr>
				...
				<td><select onchange="switchHide(this.value)"
					id="invoiceTypeId" name="invoiceTypeId" style="width:90px;">
				...
				<td id="tr11" style="width:90px;">加油对象</td>
				<td id="tr11-1"><input class="easyui-validatebox" id="content11"
					name="content11" type="text" placeholder="加油对象" style="width:90px;" /></td>

				<td id="tr12" style="width:90px;">加油升数</td>
				<td id="tr12-2"><input class="easyui-validatebox" id="content12"
					name="content12" type="text" placeholder="加油升数" style="width:90px;" /></td>

				<td id="tr13" style="width:90px;">车辆公里数</td>
				<td id="tr13-3"><input class="easyui-validatebox" id="content13"
					name="content13" type="text" placeholder="车辆公里数"
					style="width:90px;" /></td>

				<td id="tr21" style="display:none">加油对象</td>
				<td id="tr21-1" style="display:none"><input
					class="easyui-validatebox" id="content21" name="content21"
					type="text" placeholder="加油对象" style="width:90px;" /></td>

				<td id="tr22" style="display:none">加油升数</td>
				<td id="tr22-2" style="display:none"><input
					class="easyui-validatebox" id="content22" name="content22"
					type="text" placeholder="加油升数" style="width:90px;" /></td>

				<td id="tr23" style="display:none">车辆公里数</td>
				<td id="tr23-3" style="display:none"><input
					class="easyui-validatebox" id="content23" name="content23"
					type="text" placeholder="车辆公里数" style="width:90px;" /></td>

				<td id="tr31" style="display:none">天数</td>
				<td id="tr31-1" style="display:none"><input
					class="easyui-validatebox" id="content31" name="content31"
					type="text" placeholder="天数" style="width:90px;" /></td>

				<td id="tr32" style="display:none">人数</td>
				<td id="tr32-2" style="display:none"><input
					class="easyui-validatebox" id="content32" name="content32"
					type="text" placeholder="人数" style="width:90px;" /></td>

				<td id="tr33" style="display:none">住宿地点</td>
				<td id="tr33-3" style="display:none"><input
					class="easyui-validatebox" id="content33" name="content33"
					type="text" placeholder="住宿地点" style="width:90px;" /></td>

				<td id="tr41" style="display:none">交通工具</td>
				<td id="tr41-1" style="display:none"><input
					class="easyui-validatebox" id="content41" name="content41"
					type="text" placeholder="交通工具" style="width:90px;" /></td>

				<td id="tr42" style="display:none">起止点</td>
				<td id="tr42-2" style="display:none"><input
					class="easyui-validatebox" id="content42" name="content42"
					type="text" placeholder="起止点" style="width:90px;" /></td>

				<td id="tr51" style="display:none">修理对象</td>
				<td id="tr51-1" style="display:none"><input
					class="easyui-validatebox" id="content51" name="content51"
					type="text" placeholder="修理对象" style="width:90px;" /></td>

				<td id="tr52" style="display:none">修理内容</td>
				<td id="tr52-2" style="display:none"><input
					class="easyui-validatebox" id="content52" name="content52"
					type="text" placeholder="修理内容" style="width:90px;" /></td>

				<td id="tr71" style="display:none">招待事由</td>
				<td id="tr71-1" style="display:none"><input
					class="easyui-validatebox" id="content71" name="content71"
					type="text" placeholder="招待事由" style="width:90px;" /></td>

				<td id="tr72" style="display:none">饭店名称</td>
				<td id="tr72-2" style="display:none"><input
					class="easyui-validatebox" id="content72" name="content72"
					type="text" placeholder="饭店名称" style="width:90px;" /></td>

				<td id="tr81" style="display:none">票据内容</td>
				<td id="tr81-1" style="display:none"><input
					class="easyui-validatebox" id="content81" name="content81"
					type="text" placeholder="票据内容" style="width:90px;" /></td>

				<td id="tr82" style="display:none">数量</td>
				<td id="tr82-2" style="display:none"><input
					class="easyui-validatebox" id="content82" name="content81"
					type="text" placeholder="数据" style="width:90px;" /></td>

				<td id="tr83" style="display:none">单价</td>
				<td id="tr83-3" style="display:none"><input
					class="easyui-validatebox" id="content83" name="content83"
					type="text" placeholder="单价" style="width:90px;" /></td>

				<td id="tr91" style="display:none">票据内容</td>
				<td id="tr91-1" style="display:none"><input
					class="easyui-validatebox" id="content91" name="content91"
					type="text" placeholder="票据内容" style="width:90px;" /></td>

				<td id="tr92" style="display:none">数量</td>
				<td id="tr92-2" style="display:none"><input
					class="easyui-validatebox" id="content92" name="content92"
					type="text" placeholder="数量" style="width:90px;" /></td>

				<td id="tr93" style="display:none">单价</td>
				<td id="tr93-3" style="display:none"><input
					class="easyui-validatebox" id="content93" name="content93"
					type="text" placeholder="单价" style="width:90px;" /></td>

				<td id="tr101" style="display:none">票据内容</td>
				<td id="tr101-1" style="display:none"><input
					class="easyui-validatebox" id="content101" name="content101"
					type="text" placeholder="票据内容" style="width:90px;" /></td>

				<td id="tr102" style="display:none">数量</td>
				<td id="tr102-2" style="display:none"><input
					class="easyui-validatebox" id="content102" name="content102"
					type="text" placeholder="数量" style="width:90px;" /></td>

				<td id="tr103" style="display:none">单价</td>
				<td id="tr103-3" style="display:none"><input
					class="easyui-validatebox" id="content103" name="content103"
					type="text" placeholder="单价" style="width:90px;" /></td>

				<td id="tr111" style="display:none">费用内容</td>
				<td id="tr111-1" style="display:none"><input
					class="easyui-validatebox" id="content111" name="content111"
					type="text" placeholder="费用内容" style="width:90px;" /></td>

				<td style="display:none">录入时间</td>
				<td style="display:none"><input class="easyui-validatebox"
					id='createDate' name='createDate' value="${csrqstart}"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="readonly"
					placeholder="录入时间" style="width:90px;" /></td>
				...
				<td><input class="easyui-validatebox" id="content"
					...
					data-options="required:true" style="width:90px;" /></td>
				...
				<!-- <td style="display:none">经办人</td>
				<td style="display:none"><input class="easyui-validatebox" id="operatorId"
