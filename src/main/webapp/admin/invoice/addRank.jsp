	...
	<form id="invoice_add_form">
		...
		<table>
			<tr>
				...
				<td id="tr11">加油对象</td>
				<td id="tr11"><input class="easyui-validatebox" id="content11"
					name="content11" type="text" placeholder="加油对象"
					style="width:160px;" /></td>

				<td id="tr12">加油升数</td>
				<td id="tr12"><input class="easyui-validatebox" id="content12"
