...
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(5, '用户管理', null, '1', '/admin/user/manage.jsp', '1', '管理用户模块', '2', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(6, '查看用户', null, '1', '/userController/admin/get*.do', '2', '查看用户', '5', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(7, '添加用户', null, '2', '/userController/admin/add*.do', '2', '添加用户', '5', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(8, '编辑用户', null, '3', '/userController/admin/edit*.do', '2', '编辑用户', '5', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(9, '删除用户', null, '4', '/userController/admin/delete*.do', '2', '删除用户', '5', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(10, '角色管理', null, '2', '/admin/role/manage.jsp', '1', '管理角色模块', '2', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(11, '查看角色', null, '1', '/roleController/admin/get*.do', '2', '查看角色', '10', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(12, '添加角色', null, '2', '/roleController/admin/add*.do', '2', '添加角色', '10', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(13, '编辑角色', null, '3', '/roleController/admin/edit*.do', '2', '编辑角色', '10', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(14, '删除角色', null, '4', '/roleController/admin/delete*.do', '2', '删除角色', '10', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(15, '授予权限', null, '5', '/roleController/admin/grant*.do', '2', '授予角色权限', '10', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(16, '发票管理', null, '1', '/admin/invoice/manage.jsp', '1', '管理发票', '3', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(17, '查看发票', null, '1', '/invoiceController/get*.do', '2', '查看发票', '16', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(18, '添加发票', null, '2', '/invoiceController/add*.do', '2', '添加发票', '16', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(19, '编辑发票', null, '3', '/invoiceController/edit*.do', '2', '编辑发票', '16', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(20, '删除发票', null, '4', '/invoiceController/delete*.do', '2', '删除发票', '16', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(21, '审核发票', null, '2', '/admin/invoice/manageAudit.jsp', '1', '审核发票', '3', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(22, '职务管理', null, '2', '/admin/post/manage.jsp', '1', '职务管理模块', '4', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(23, '查看职务', null, '1', '/postController/admin/getByPage*.do', '2', '查看职务', '22', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(24, '添加职务', null, '2', '/postController/admin/add*.do', '2', '添加职务', '22', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(25, '编辑职务', null, '3', '/postController/admin/edit*.do', '2', '编辑职务', '22', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(26, '删除职务', null, '4', '/postController/admin/delete*.do', '2', '删除职务', '22', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(27, '站点管理', null, '1', '/admin/site/manage.jsp', '1', '站点管理模块', '4', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(28, '查看站点', null, '1', '/siteController/admin/getByPage*.do ', '2', '查看站点', '27', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(29, '添加站点', null, '2', '/siteController/admin/add*.do', '2', '添加站点', '27', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(30, '编辑站点', null, '3', '/siteController/admin/edit*.do', '2', '编辑站点', '27', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(31, '删除站点', null, '4', '/siteController/admin/delete*.do', '2', '删除站点', '27', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(32, '查看站点详细信息', null, '4', '/siteController/admin/getSiteInformation*.do', '2', '查看站点详细信息', '27', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(33, '查看站点用户及其职务', null, '1', '/siteController/admin/getUserInformationOfOneSiteByPage*.do', '2', '查看站点用户及其职务', '28', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(34, '添加站点用户', null, '2', '/siteController/admin/addUserSite*.do', '2', '添加站点用户', '26', 1, 1);
insert into resource(Id,Name,Icon,Sequence,Url,Type,Description,ParentId,IsLeaf,IsEnable) values(35, '删除站点用户', null, '3', '/siteController/admin/deleteUserSite*.do', '2', '删除站点用户', '26', 1, 1);
